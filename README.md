...
> **Branch note:** This is the `ironieser` personal-site branch, currently including the v2.0.0 config structure and page-view analytics. The clean reusable template remains on `master`; shared features are staged through `dev`. See [CHANGELOG.md](CHANGELOG.md) for details.
