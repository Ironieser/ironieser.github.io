...
> **Latest template update:** safer GitHub Pages CI/deployment, repaired link checking, hardened optional Scholar sync, content-hashed publication images, back-to-top navigation, and optional self-hosted visitor analytics. See [CHANGELOG.md](CHANGELOG.md) for details.
...
- If you use Cloudflare Pages, disable the GitHub Pages deployment workflow or use a separate deployment branch.
