...
- **RSI surfaced** — the roadmap footnote is now a "Self-Improvement Loop" (agent traces and synthetic data retrain the models they run on), and Stage 03 gains a "Recursive Self-Improvement · Next" card beside Long-term Memory.
