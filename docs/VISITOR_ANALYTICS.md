...
- Visit the site, then open `https://your-domain.example/api/stats` → it should return JSON with counts.
- Your private dashboard data is available at `https://your-domain.example/api/admin?key=<ADMIN_KEY>`.
